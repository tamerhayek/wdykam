...
<div class="flex min-h-screen w-full flex-col gap-5 p-3">
	<div class="flex w-full flex-col gap-3 rounded-xl border-2 border-primary bg-base-200 px-4 py-3">
		<h1 class="w-full text-2xl font-bold">Quante ne sai su di me?</h1>
		{#if participant}
			<div class="flex items-center gap-2">
				<div class="size-10 overflow-hidden rounded-full border-2 border-primary">
					<img
